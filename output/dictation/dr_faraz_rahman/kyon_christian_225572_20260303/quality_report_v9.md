# Quality Report — kyon_christian_225572_20260303

**Pipeline Version:** v9  
**Overall Score:** 4.0 / 5.0  
**Keyword Overlap:** 66%  
**Evaluation time:** 9.3s  
...
**Evaluator notes:**
> The generated note accurately captures the patient's symptoms and treatment plan, but contains some minor inaccuracies in the physical examination findings. The language is mostly clinical, but with some lapses into informal terminology.
...
**Missing (vs gold):** SUBJECTIVE, OBJECTIVE  
