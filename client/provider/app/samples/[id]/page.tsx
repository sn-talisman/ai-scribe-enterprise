...
export default async function EncounterDetailPage({ params, searchParams }: Props) {
        ...
        {sampleDetail && (
          <div className="flex items-center gap-3 mt-2">
            <span
              ...
              style={{
                background: sampleDetail.mode === "dictation" ? "#EEF2FF" : "#E6F7F6",
                color: sampleDetail.mode === "dictation" ? "#6366F1" : "#3A9E9C",
              }}
            >
              {sampleDetail.mode}
            </span>
        ...
        <div className="flex items-center gap-2 mt-3">
          ...
          {(sampleDetail?.versions ?? [version]).map((v) => (
            <a
              ...
              style={{
                background: v === version ? "var(--brand-accent)" : "#F1F5F9",
